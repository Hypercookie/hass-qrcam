...
add `https://github.com/Hypercookie/hass-qrcam/edit/master/info.md` to your custom repositories <br>(open the hacs integration view -> three dots right upper corner -> custom repositories -> paste url and set category to `Integration`)
### Manual
