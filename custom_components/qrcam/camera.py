...
def error_correct(value: Any) -> str:
    if value not in ERROR_CORRECT_VALUES:
        raise vol.Invalid(
            'Error Correction Unkown should be one of ["ERROR_CORRECT_L","ERROR_CORRECT_M","ERROR_CORRECT_Q","ERROR_CORRECT_H"]'
        )
    else:
        return str(value)
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional("drawer", default="square"): drawer,
        vol.Optional("color_mask", default="solid"): colormask,
    }
)
